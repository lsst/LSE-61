...
\subsubsection{Scientific Visualization of Camera Image Data}

\label{DMS-REQ-0395}
\textbf{ID:} DMS-REQ-0395

\textbf{Specification:} All scientific visualization of camera image data shall use the coordinate systems defined in \citeds{LSE-349}.

\emph{Derived from Requirements:}

OSS-REQ-0408:
Scientific Visualization of Camera Image Data \newline
...
\textbf{Specification:} The LSST database shall supply functions or tables to provide, for every SSObject, at least the phase angle for every observation, and the reduced and absolute asteroid magnitudes in all LSST bands.
...
\textbf{Specification:} Observed Solar System objects and associated metadata shall be available for public access in the DMS science data archive within time \textbf{L1PublicT }of their generation by the DMS.
