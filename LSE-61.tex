...
This section contains requirements that are not yet part of the approved baseline, but which are being considered for inclusion.
...
\textbf{Discussion:}
The relevant metrics are listed in the table photometricPerformance below:
...
\textbf{Discussion:}
The relevant metrics are listed in the table below:
...
These requirements were originally approved in narrative text in \citeds{LDM-135}, but are now being promoted to \citeds{LSE-61}.

\subsubsection{Fast turnaround for high-volume full-sky queries on the Object table}

\label{DMS-REQ-0357}
\textbf{ID:} DMS-REQ-0357 (Priority: 1b)

\textbf{Specification:}
High-volume queries on the Object table -- queries that involve full-sky scans -- shall be answered in 1 hour.

\subsubsection{Fast turnaround for high-volume complex queries}

\label{DMS-REQ-0354}
\textbf{ID:} DMS-REQ-0354 (Priority: 1b)

\textbf{Specification:}
Complex high-volume queries -– queries that involve full-sky spatial and temporal correlations -- shall be answered in less than 12 hours.
...
\textbf{Specification:}
The system shall support 50 simultaneous high-volume queries running at any given time.
...
\textbf{Specification:}
Low volume queries shall respond within 10 seconds under a load of 100 simultaneous queries.
...
\textbf{Specification:}
The live Level 1 database shall support at least 20 simultaneous queries, assuming each query lasts no more than 10 seconds.
...
\textbf{Specification:}
The DM copy of the EFD shall support at least 5 simultaneous queries,
assuming each query lasts no more than 10 seconds.
...
\label{DMS-REQ-0375}
\textbf{ID:} DMS-REQ-0375 (Priority: 1b)

\textbf{Specification:}
Postage stamp cutouts, sized to match those in alert packets, of all observations of a single Object shall be retrievable within 10 seconds, with 10 simultaneous requests.
...
\label{DMS-REQ-0374}
\textbf{ID:} DMS-REQ-0374 (Priority: 1a)

\textbf{Specification:}
A Processed Visit Image of a single CCD shall be retrievable using the VO SIAv2 protocol within 10 seconds with 66 simultaneous requests.

\textbf{Discussion:}
\subsubsection{Retrieval of focal-plane visit images}

\label{DMS-REQ-0376}
\textbf{ID:} DMS-REQ-0376 (Priority: 1a)

\textbf{Specification:}
All Processed Visit Images for a single visit, including mask and variance planes, shall be retrievable using the VO SIAv2 protocol within 60 seconds with 20 simultaneous requests.

\subsubsection{Retrieval of focal-plane-sized images}

\label{DMS-REQ-0373}
\textbf{ID:} DMS-REQ-0373 (Priority: 1a)

\textbf{Specification:}
A 10 square degree coadd, including mask and variance planes, shall be retrievable using the VO SIAv2 protocol within 60 seconds with 20 simultaneous requests.
