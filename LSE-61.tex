...
\textbf{Specification:}
Low volume queries, queries that are spatially restricted to a circle of radius \textbf{lvSkyRadius}, shall respond within \textbf{lvQueryTime} under a load of \textbf{lvQueryUsers} simultaneous queries and return at most \textbf{lvMaxReturnedResults} of data.
